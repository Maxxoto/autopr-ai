...
import { getPR, findPRForBranch, getPRDiff, postReviewComment } from '../lib/github/pr.js';
  ...
  program
    ...
    .action(async (prNumber: string | undefined, opts: { repo?: string }) => {
      try {
        ...
        process.stdout.write(pc.bold(`Review for PR #${pr.number}: ${pr.title}\n`));
        process.stdout.write(pc.dim('─'.repeat(50)) + '\n');
        process.stdout.write(`${review}\n`);
        process.stdout.write(pc.dim('─'.repeat(50)) + '\n');
        process.stdout.write(pc.dim('Review generated by autopr AI\n'));
